...
\begin{figure*}[h]
  ...
  \caption{\label{fig:Subtypeaudiences} Audiences-based digital offerings classified according to the primordial audiences needs: emotional needs (left), educational needs (centre), stakeholder involvement needs (right)}
\end{figure*}
