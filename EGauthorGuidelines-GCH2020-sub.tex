...
Since then, guidance from organisations such as the Museums Association in the UK and the International Council of Museums (ICOM) would highlight similar challenges and steer the sector's adaptation by prioritising \textbf{(museums and covid-19 8 steps, icom & ma practical ways museums can contribute)}:
\begin{itemize}
\item security of collections and safety of staff
\item alternative/innovative approaches to conduct activities that cannot take place in the physical museum space, including new ways of working, revisiting of traditional tools, new communication channels with audiences etc
\item consider accessibility standards and procedures
\item response to societal needs and current developments, including supporting those hit hard by the pandemic (vulnerable groups such as 

\item support of health systems by donating equipment that museums hold as well as staff volunteering to physically help with a variety of assisting roles (drivers, call centres and more)
\item support of vulnerable groups such as the homeless and people suffering from dementia
\end{itemize}
